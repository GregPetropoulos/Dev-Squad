...
router.delete('/:id', [auth, checkObjectId('id')], async (req, res) => {
  try {
    ...
    //   Check user, must turn the object Id into a string, req.user.id is a string of logged in user
...
router.delete(
    ...
    async (req, res) => {
        ...
        // check if logged in user that made the comment is the same user deleting the comment
